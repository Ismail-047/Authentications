    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center p-4 py-10 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                {isVerified ? (
                    <div className="animate-themeAnimationLg backdrop-blur-lg bg-white/80 border border-gray-200 rounded-3xl p-8 shadow-2xl text-center">
                    ...
                    <form onSubmit={handleVerify} className="animate-themeAnimationLg backdrop-blur-lg bg-white/80 border border-gray-200 rounded-3xl p-8 shadow-2xl">
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200 text-center">
                            <p className="text-gray-600 text-sm">
                                Wrong email?{" "}
                                <Link to="/signup" className="text-blue-600 hover:text-blue-700 transition-colors duration-200 hover:underline font-medium">
