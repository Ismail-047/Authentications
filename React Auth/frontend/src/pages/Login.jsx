...
export default function Login() {
    ...
    const { loginWithGoogle, loginUser } = useAuthStore();
    ...
    const handleFormSubmission = async (e) => {
        ...
        if (!isValid) return toast.error("Please fill in all the fields correctly.");
                    ...
                    <form onSubmit={handleFormSubmission}
                        ...
                        <div className="flex justify-end">
                            <Link to="/request-reset-password"
                                className="text-sm text-gray-600 hover:text-gray-800 transition-colors duration-200 hover:underline my-1">
                                Forgot password?
                            </Link>
                        </div>
