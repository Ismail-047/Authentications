...
const inputClasses = "w-full py-3 border-2 rounded-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder:font-medium font-medium";
const noErrorClasses = "border-gray-200 hover:border-indigo-300 focus:border-indigo-500";
